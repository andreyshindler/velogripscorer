...
const I18N = {
  en: {
    ...
    export_csv: 'Export CSV', export_taps: 'Taps log', updated_ago: 'Updated {s}s ago', live: 'LIVE',
  ...
  he: {
    ...
    export_csv: 'ייצוא CSV', export_taps: 'יומן חציות', updated_ago: 'עודכן לפני {s} שניות', live: 'שידור חי',
